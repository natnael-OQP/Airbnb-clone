                ...
                searchInput.trim() && (
                    <div className="col-span-3 mx-auto flex flex-col mt-3 " >      
                        ...
                        <div className="flex justify-around  pb-3 " >
                            ...
                            <button
                                onClick={goToSearch}
                                className="font-semibold max-w-[200px] text-red-400 m-1 px-2 py-1 bg-white shadow-sm  hover:bg-[#FE595E] hover:text-white hover:shadow-md transition duration-200 transform ease-in-out  " >Search</button>
                        </div>
                    </div>
                )
            }
